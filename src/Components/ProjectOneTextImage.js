...
import { Segment, Image, Rail, SegmentGroup } from 'semantic-ui-react';

// import src from  '../project1.jpg'

const ProjectOneTextImage = () => (
  <Segment>
      {/* <Image src={ src } style={{width:'800px',height:'500px'}}/> */}

      <Rail attached internal style={{
 width: '65%', marginLeft: '40%', marginTop: '15%', textAlign: 'left' 
}}>
