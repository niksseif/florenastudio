...
const TextBodyLanding = () => (
    <div>
        <Segment center >
            <Header as='h2' style={{textAlign:'left'}}>Design Style</Header>
            <p style={{ width: '100%', marginLeft: 'auto', marginRight: 'auto', textAlign:'left' }}>
...
export default TextBodyLanding